...
module.exports = [
  ...
  webviewAssetPatch({
    ...
    order: 1030,
    ciPolicy: "optional",
    pattern: /^(diff-view-mode|use-resolved-theme-variant)-.*\.js$|^app-initial~app-main~.*(?:projects-index-page~app|remote-conversation).*\.js$/,
  ...
  webviewAssetPatch({
    ...
    order: 1040,
    ciPolicy: "optional",
    pattern: /^(?:use-window-controls-safe-area-|app-initial~app-main~.*(?:remote-conversation|projects-index-page).*).*\.js$/,
