...
const EXPECTED_PATCHES = [
  ...
  "feature:api-key-model-visibility:api-key-model-visibility-ui",
  "feature:api-key-service-tier:api-key-service-tier-gate",
  "feature:api-key-service-tier:api-key-service-tier-model",
  "feature:api-key-service-tier:api-key-service-tier-fallback",
  ...
  "feature:chatgpt-dual-backend:chatgpt-request-routing",
  "feature:chatgpt-dual-backend:chatgpt-chat-entitlement",
  "feature:chatgpt-dual-backend:sites-availability",
