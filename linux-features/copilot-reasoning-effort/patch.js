  ...
  descriptors: [
    {
      ...
      phase: "webview-asset",
      pattern: /^(use-model-settings|use-collaboration-mode|app-initial~app-main~.*(?:onboarding-page|thread-app-shell-chrome|page))-.*\.js$/,
    ...
    },
    {
      ...
      phase: "webview-asset",
      pattern: /^(font-settings|model-queries|app-initial~app-main~.*(?:onboarding-page|thread-app-shell-chrome|page))-.*\.js$/,
