...
assert(
  descriptor.pattern.test(
    "app-initial~artifact-tab-content.electron~notebook-preview-panel~app-main~pull-request-rout~ns5rw1zk-current.js",
  ),
);
assert(
  !descriptor.pattern.test(
    "app-initial~app-main~new-thread-panel-page~onboarding-page~appgen-library-page~hotkey-windo~nrw3o0ql-previous.js",
  ),
);
...
console.log("4/4 open-target-discovery eval scenarios passed");
