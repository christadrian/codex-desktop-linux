...
const patches = [
  ...
  },
  {
    ...
    order: 20_730,
    ciPolicy: "optional",
    pattern: /^app-initial~artifact-tab-content\.electron~app-main~appgen-settings-page~page~pull-request-r~napudbu0-[^.]+\.js$/,
    missingDescription: "app shell window-controls layout bundle",
    skipDescription: "frameless titlebar webview layout patch",
    apply: applyFramelessTitlebarWebviewPatch,
  },
  {
    id: "webview-window-controls-chrome",
    phase: "webview-asset",
    order: 20_731,
    ciPolicy: "optional",
    pattern: /^app-initial~app-main~onboarding-page~hotkey-window-thread-page~quick-chat-window-page~chatg~gwqc41kz-[^.]+\.js$/,
    missingDescription: "app platform chrome bundle",
