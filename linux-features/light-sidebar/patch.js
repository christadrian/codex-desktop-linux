...
function applyLightSidebarCssPatch(source) {
  ...
  const patch = [
    ...
    "[data-codex-window-type=\"electron\"].electron-light {",
    ...
    "    color-scheme: light;",
    "}",
    "[data-codex-window-type=\"electron\"].electron-light .bg-token-main-surface-primary,",
    "[data-codex-window-type=\"electron\"].electron-light .bg-token-bg-primary,",
    "[data-codex-window-type=\"electron\"].electron-light .bg-token-sidebar,",
    "[data-codex-window-type=\"electron\"].electron-light [class*=\"bg-token-main-surface\"],",
    "[data-codex-window-type=\"electron\"].electron-light .app-shell-left-panel {",
    "    background-color: var(--gray-50) !important;",
    "}",
    "[data-codex-window-type=\"electron\"].electron-light body {",
    "    background-color: var(--gray-50) !important;",
    "}",
    "",
  ].join("\n");
...
const descriptors = [
  {
    ...
    order: 5000,
    ciPolicy: "optional",
    pattern: /^app(?:-main)?-[a-zA-Z0-9_-]+\.css$/,
